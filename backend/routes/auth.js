...
router.get('/google/callback', 
  passport.authenticate('google', { failureRedirect: 'https://merry-melomakarona-c50f0e.netlify.app/login' }),
  (req, res) => {
    ...
    res.redirect(`https://merry-melomakarona-c50f0e.netlify.app/?token=${token}`);
  }
);
